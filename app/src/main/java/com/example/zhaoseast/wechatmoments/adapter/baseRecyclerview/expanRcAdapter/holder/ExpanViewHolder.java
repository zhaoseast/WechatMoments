package com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.holder;
...
public abstract class ExpanViewHolder extends RecyclerView.ViewHolder {
    ...
    public ExpanViewHolder(Context ctx, View itemView, int viewType) {
        super(itemView);
        switch (viewType) {
