package com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.adapter;
...
import com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.bean.BaseItem;
import com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.bean.GroupItem;
import com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.bean.RecyclerViewData;
import com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.holder.ExpanViewHolder;
import com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.listener.OnRecyclerViewListener;

import java.util.ArrayList;
import java.util.List;

import static com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.holder.ExpanViewHolder.VIEW_TYPE_CHILD;
import static com.example.zhaoseast.wechatmoments.adapter.baseRecyclerview.expanRcAdapter.holder.ExpanViewHolder.VIEW_TYPE_PARENT;


/**
 * @Description:expandRecyclerview 的 adapter
 * @Createdtime:2019/1/5 12:44
 * @Author:Zhaohd
 * @Version: V.1.0.0
 */
public abstract class ExpanRecyclerViewAdapter<T,S,VH extends ExpanViewHolder> extends RecyclerView.Adapter<VH> {

    public static final String TAG = ExpanRecyclerViewAdapter.class.getSimpleName();
    ...
    public ExpanRecyclerViewAdapter(Context ctx, List<RecyclerViewData> datas) {
        this.ctx = ctx;
        this.allDatas = datas;
        setShowingDatas();
    ...
    private int getChildPosition(int groupPosition, int showDataPosition) {
        ...
        try {
            if(childDatas.get(groupPosition)!=null){
    ...
    /**
     * return <VH extends ExpanViewHolder> instance
     */
