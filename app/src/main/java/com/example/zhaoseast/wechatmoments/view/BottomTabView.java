package com.example.zhaoseast.wechatmoments.view;
...
/**
 * @Description:BottomTabView
 * @Createdtime:2019/1/3 16:36
 * @Author:Zhaohd
 * @Version: V.1.0.0
 */
...
public class BottomTabView extends LinearLayout {
    ...
    public static class TabItemView extends LinearLayout {
        ...
        public void setStatus(int status) {
            tvTitle.setTextColor(getResources().getColor(status == PRESS ? colorPress : colorDef));
